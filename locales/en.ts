const en = {
  ...
  "exams.addSectionOrQuestion": "Add a section or question to get started",
  "exams.section": "Section",
  "exams.sectionTitle": "Section Title",
  "exams.enterSectionTitle": "Enter section title...",
  "exams.isSection": "Is this a section?",
  "exams.sections": "sections",
  "exams.untitledSection": "Untitled Section",
  "exams.clickToAdd": "Click to add question to this section",
  "exams.noSectionsAvailable": "No sections available",
  "exams.createSectionFirst": "Create a section first",
  "exams.moveToSection": "Move to Section",
  "exams.removeFromSection": "Remove from Section",
  "exams.networkError": "Network error. Please check your connection and try again.",
  "exams.timeoutError": "Request timed out. Please try again.",
  "exams.extractionFailed": "Failed to extract questions. Please try again.",
  "selectSection": "Select Section",
  "exams.movingQuestion": "Moving question",
  "exams.createSection": "Create Section",
  "exams.addToSection": "Add to Section",
  "exams.addQuestion": "Add Question",
  "exams.questionMovedToSection": "Question moved to section successfully",
