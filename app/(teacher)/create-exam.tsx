  ...
  const handleAIExtraction = async (
    ...
    try {
      ...
      const newQuestions = Array.isArray(data.questions)
        ? data.questions.filter((q : any) => q.question && q.question.trim().length > 5)
        : [];
      ...
      const merged = [
        ...
        ...newQuestions.map((q: any) => ({
          ...q,
          // 1. **DO NOT OVERWRITE ID:** Use the AI-generated ID (q.id) as the key.
          //    This is crucial because q.parent_id relies on these IDs.
          // 2. **DO NOT OVERWRITE PARENT_ID:** The parent_id is generated by the AI 
          //    and should be preserved to maintain nesting structure.
          points: q.points?.toString() || '1',
